...
export const data = [
  ...
  }, // data 배열 의 두번째 원소 : 객체2 (생선 타코)
  {
    "name": "샹그리아",
    "ingredients": [
      { "name": "Charles Heidsieck, Brut Reserve", "amount": 500, "measurement": "그램" },
      { "name": "Hakushu 25", "amount": 1, "measurement": "컵" },
      { "name": "Yamazaki 25", "amount": 2, "measurement": "컵" },
      { "name": "Hibiki 21", "amount": 2, "measurement": "개(큰것)" },
      { "name": "조니워커블루", "amount": 3, "measurement": "개" }
    ],
    "steps": [
      "로얄살루트21에 익힌다.",
      "발렌타인21년 3장 위에 프란시스 커정 724 얹는다.",
      "34번가생제르망 솔리드 퍼퓸에 얹은 뱀부하모니 위에 블랙베리앤베이, 베티베디베, 집시워터 얹는다."
    ]
  } // data 배열 의 두번째 원소 : 객체2 (생선 타코)
]
